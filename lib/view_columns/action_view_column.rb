    ...
    def name  #:nodoc:
      ...
      if(self.show_single_select_all_checkbox)
        html = content_tag(:span, check_box_tag("select_all", nil, false, 
          ...
          :id => 'select_all_span', 
          :onclick => 'javascript: $(this).hide(); $("select_all_checkbox").checked=false; $("deselect_all_span").show()') + '' +
          ...
          :onclick => 'javascript:  $(this).hide(); $("deselect_all_checkbox").checked=true; $("select_all_span").show()')
      else
